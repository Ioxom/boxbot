...
/**
 * runs through the {@link ConfirmationGetter ConfirmationGetters} contained in {@link ConfirmationGetter#CONFIRMATION_GETTERS} and checks if we've gotten confirmation from the referenced users <br>
